...
![process of day 1](../docs/pictures/the_proccess_of_day_1.jpg)
## **Day two**
Today, finished building the building flat for my printer so it will be easier for me to build things later. I somehow got an aluminum profile lost, so I had to buy one on the internet and had to wait for severel days until it came. This delayed my proccess by a little bit. So remember to keep your things safely inside a box, or you will lose many things.
## **Day three**
For day three, I finished building the frame. There was a problem though, one of the holes in one of the aluminum profiles was not in the right spot and one of my pritned parts almost cracked because of this. Lessons learned: 1. check all of the things you have bought before using them. 2. don't use too much strength when screws can't go in.
![problems of aluminum profile](../docs/pictures/problem%20of%20aluminum%20profile%201.jpg)
## **Day four**
To now I have finished setting the PMMA board. Tomorrow, I will be starting to build the AB drives.
## **Day five**
...
![proccess of day 8](../docs/pictures/process_of_day_8_2.jpg)
## **Day nine**
Today I crimped many terminals and made many wires that connect all kinds of electronics to the PCB board and then to my SKR Pico, which is in charge of all of my printer's actions. I wanted to start building the tophat but didn't because one of the printed aprts have gotten lost and I couldn't start because of that. I haven't stuck my rasberrypi to the printer yet because there is something wrong with the systems. That is also the reason why I haven't sealed the box yet.
![proccess of day 9](../docs/pictures/process_of_day_nine.jpg)
## **Day ten**
I finished building the tophat and putting it on to the printer. I managed to deal with the systematic problems of my rasberrypi, but I still haven't sealed the box for final checks and organizing the wires. I will be using cable ties to secure the wires so that they don't get strangled by the printer while moving.
![proccess of day 10](../docs/pictures/process_of_day_ten.jpg)